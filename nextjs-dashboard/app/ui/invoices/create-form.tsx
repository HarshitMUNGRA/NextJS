...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  return (
<form action={formAction} noValidate> {/* Prevents default browser validation */}
...
<p id="customer-error" className="mt-1 text-sm text-red-500">
...
>
          ...
          {state.errors?.status && (
<p id="status-error" className="mt-1 text-sm text-red-500">
